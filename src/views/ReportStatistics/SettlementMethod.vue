	...
	<div class="SettlementMethod">
		<div class="Position_top">
			<el-breadcrumb separator="/">
				...
				<el-breadcrumb-item>结算方式汇总</el-breadcrumb-item>
			</el-breadcrumb>
		</div>
		<div class="cont_top">
		...
		<div class="cont_table">
			...
			>
				...
				<el-table-column
						prop="bawangamount"
						label="霸王餐金额" align="right" width="140">
				</el-table-column>
				<el-table-column
						prop="miandanamount"
						label="免单金额"
    ...
    export default {
        ...
        methods:{
            ...
            onInquire(){
                ...
                this.$post(this.$api.jiesuanfangshihuizongchaxun,data).then(data=>{
                    console.log(data);
                    if(data.code==0){
