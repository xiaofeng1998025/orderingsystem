    ...
    <div class="Warehouse">
        <div class="Position_top">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>原料入库管理</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <div class="Position_cont_table">
                <el-table
                    ...
                    <el-table-column
                            ...
                            width="300">
                        <template slot-scope="scope">
                            <el-button type="primary" @click="onckmx(scope.row)"  size="small">入库明细</el-button>
        ...
        <div class="Thepopup Thepopupmx">
            <el-dialog :close-on-click-modal="false" :visible.sync="Modifmxtc">
                <div class="Thepopupmx_top">
                    <el-button type="danger" icon="el-icon-plus" size="small" @click="onnewckyl">新增入库原料</el-button>
                    <div>
    ...
    export default {
        ...
        methods:{
            ...
            initList(){
                ...
                this.$post(this.$api.goodsRukulist,{
                    startdate:startdate,
                    enddate:enddate,
                    status:this.cxshxx,
                    code:this.cxdjbh,
            ...
            ondetermine(){
                if(this.type=='new'){
                    ...
                    console.log(data);
                    //新增
                    this.$post(this.$api.goodsRukuadd,data).then(data=>{
                        if(data.code==0){
                            this.$message({
                                message: '添加成功',
                                type: 'success'
                    ...
                    console.log(data);
                    this.$post(this.$api.goodsRukuedit,data).then(data=>{
                        if(data.code==0){
                            this.$message({
                                message: '修改成功',
                                type: 'success'
